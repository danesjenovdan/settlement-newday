import { NewDayEngineConfig, NewDaySettlementEngine } from '.'
...
const LEDGER_PREFIX = process.env.LEDGER_PREFIX || 'newday'
...
const config: NewDayEngineConfig = {
  host: ENGINE_HOST,
  port: +ENGINE_PORT,
  mode: ENGINE_MODE,
...
const engine = new NewDaySettlementEngine(config)
